...
class PPE_detect:
    ...
    def __init__(self):
        # 加载模型 yolov5n.pt 速度是最快的
        self.model = torch.hub.load('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/yolov5', 'custom', path='/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/yolov5/weights/yolov5n.pt',source='local')  # local repo
        # 置信度阈值
        self.model.conf = 0.3
        # 加载摄像头
        ...
        # 加载浮层
        self.overlay_person = self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/person.png')
        self.overlay_vest = [
            self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/vest_on.png'),
            self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/vest_off.png')
        ]
        # 
        self.overlay_hat = [
            self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/hat_blue.png'),
            self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/hat_red.png'),
            self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/hat_white.png'),
            self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/hat_yellow.png'),
            self.getPng('/home/miaojiawei/桌面/python_vision/17-19YOLOv5工地防护/icons/hat_off.png'), # 最后一个不戴帽子
        ]
